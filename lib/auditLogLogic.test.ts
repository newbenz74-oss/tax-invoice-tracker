...
describe('formatFieldValue', () => {
  ...
  it('คอลัมน์วันที่แสดงเป็น พ.ศ. ให้ตรงกับตารางหน้าอื่น ไม่ใช่ ISO ดิบ', () => {
    expect(formatFieldValue('transaction_date', '2026-09-14')).toBe('14/09/2569');
    expect(formatFieldValue('expected_date', '2026-10-01')).toBe('01/10/2569');
    expect(formatFieldValue('issued_date', '2025-12-31')).toBe('31/12/2568');
  });
