...
/**
 * พื้นหลังวิดีโอหน้า login แบบสลับ 5 คลิปวนลูป (2026-07-17) — เล่นคลิปที่ 1 จนจบ ค่อยๆ crossfade ไป
 * คลิปที่ 2 แล้ววนไปเรื่อยๆ จนครบ 5 คลิปแล้ววนกลับไปคลิปที่ 1 ใหม่ ไม่มีจอกระพริบ/ดำระหว่างเปลี่ยนคลิป
 *
