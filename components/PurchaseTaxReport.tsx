      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="entrance-animate entrance-delay-2 flex gap-2">
          <button
            ...
            className="btn-press flex items-center gap-1.5 rounded-[10px] border border-border bg-primary/6 px-4 py-2.5 text-sm font-medium text-text hover:bg-primary/12 disabled:opacity-50"
